...
const mapResult = (r) => r ? ({ id: r.id, memberId: r.member_id, workoutId: r.workout_id, sessionId: r.session_id, score: r.score, scoreType: r.score_type, rx: r.rx, notes: r.notes, date: r.date, highFives: r.high_fives || [] }) : null;
